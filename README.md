# Игра Gem Crash
Игра представляет собой поле с юнитами-фишками, которые нужно предвигать и собирать в лини одинкаовых цветов
Очки даются только за фишки с кристаллом
Реализованы осбоые фишки:
...
Graphic objects- моудль с параматрами отрисовки
